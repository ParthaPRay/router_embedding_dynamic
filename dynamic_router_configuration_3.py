...
###########
# Configuration: 3: add function, heapsort, factorial
###########
# Ask the code by follows
# To do add: curl -X POST http://localhost:5000/process_prompt -H "Content-Type: application/json" -d '{"prompt": "What is 3 raised to the power of 2?"}'
...
"""
        ...
        examples = """
Example 1:
User: Calculate the factorial of 1
Assistant:
