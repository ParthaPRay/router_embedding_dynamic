...
###########
# Configuration: 6: add function, heapsort, factorial, sentiment analysis, rule-based text keyword extraction, timezone of a city in IANA format
###########
...
# To do time information in IANA format: curl -X POST http://localhost:5000/process_prompt -H "Content-Type: application/json" -d '{"prompt": "What is the time in Asia/Tokyo?"}'
...
def get_current_time_in_city(city: str) -> str:
    ...
    The city should be in the format of a timezone name like "Europe/London", "America/New_York", etc.
    """
    try:
        # Use zoneinfo to get the timezone of the city
...
# Define the schema for time zone
time_zone_schema = {
    ...
    "parameters": {
        ...
        "properties": {
            "city": {
                "type": "string",
                "description": "The name of the city (timezone format like 'America/New_York')."
            }
        },
        "required": ["city"]
    }
...
routes = [
    ...
    Route(
        name="time_in_city",
        utterances=[
            "What is the time in Asia/Kolkata",
            "Current time in Europe/London",
            "Tell me the time in Africa/Johannesburg",
            "Give me the time for Australia/Sydney",
            "What is current time of Pacific/Honolulu?"
        ],
        dynamic=True,
        functions=[get_current_time_in_city],
        function_schemas=[time_zone_schema]
    ),
    Route(
        name="gcd",
        utterances=[
...
Result: 15
"""
    elif route.name == "time_in_city":
        examples = """
Example 1:
User: What is the time in Europe/London?
Assistant:
Function: get_current_time_in_city
Arguments: {"city": "Europe/London"}
Result: 2024-09-23 14:15:00

Example 2:
User: Current time in America/New_York
Assistant:
Function: get_current_time_in_city
Arguments: {"city": "America/New_York"}
Result: 2024-09-23 09:15:00

Example 3:
User: Tell me the time in Asia/Kolkata
Assistant:
Function: get_current_time_in_city
Arguments: {"city": "Asia/Kolkata"}
Result: 2024-09-23 19:45:00
"""
    else:
...
def parse_llm_response(response_text):
    ...
    function_mapping = {
        ...
        "get_current_time_in_city": "get_current_time_in_city"    # timezone
    }
