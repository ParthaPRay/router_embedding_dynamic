...
# This curl caller code calls the API executed by 'dynamic_router_configuration_6.py'
# 
# Config 6: add, heapsort, factorial, sentiment analysis, GCD, timezone dynamic route
...
prompts = [
    ...
    # Exact match for dynamic route (time_in_city)
    ...
    "GCD of 9 and 6",
    # Partial match for dynamic route (time_in_city)
